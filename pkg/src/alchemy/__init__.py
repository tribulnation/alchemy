...
from .core import (
  ALCHEMY_DATA_API_URL as _ALCHEMY_DATA_API_URL,
  ETHEREUM_ALCHEMY_RPC_URL as _ETHEREUM_ALCHEMY_RPC_URL,
  BNB_ALCHEMY_RPC_URL as _BNB_ALCHEMY_RPC_URL,
  POLYGON_ALCHEMY_RPC_URL as _POLYGON_ALCHEMY_RPC_URL,
  BASE_ALCHEMY_RPC_URL as _BASE_ALCHEMY_RPC_URL,
  AVAX_ALCHEMY_RPC_URL as _AVAX_ALCHEMY_RPC_URL,
  OPTIMISM_ALCHEMY_RPC_URL as _OPTIMISM_ALCHEMY_RPC_URL,
  ARBITRUM_ALCHEMY_RPC_URL as _ARBITRUM_ALCHEMY_RPC_URL,
  GNOSIS_ALCHEMY_RPC_URL as _GNOSIS_ALCHEMY_RPC_URL,
  CELO_ALCHEMY_RPC_URL as _CELO_ALCHEMY_RPC_URL,
  ETHEREUM_ALCHEMY_NFT_URL as _ETHEREUM_ALCHEMY_NFT_URL,
  BNB_ALCHEMY_NFT_URL as _BNB_ALCHEMY_NFT_URL,
  POLYGON_ALCHEMY_NFT_URL as _POLYGON_ALCHEMY_NFT_URL,
  BASE_ALCHEMY_NFT_URL as _BASE_ALCHEMY_NFT_URL,
  AVAX_ALCHEMY_NFT_URL as _AVAX_ALCHEMY_NFT_URL,
  OPTIMISM_ALCHEMY_NFT_URL as _OPTIMISM_ALCHEMY_NFT_URL,
  ARBITRUM_ALCHEMY_NFT_URL as _ARBITRUM_ALCHEMY_NFT_URL,
  GNOSIS_ALCHEMY_NFT_URL as _GNOSIS_ALCHEMY_NFT_URL,
  CELO_ALCHEMY_NFT_URL as _CELO_ALCHEMY_NFT_URL,
)
...
RPC_URLS: dict[Network, str] = {
  'ethereum': _ETHEREUM_ALCHEMY_RPC_URL,
  'bnb': _BNB_ALCHEMY_RPC_URL,
  'polygon': _POLYGON_ALCHEMY_RPC_URL,
  'base': _BASE_ALCHEMY_RPC_URL,
  'avalanche': _AVAX_ALCHEMY_RPC_URL,
  'optimism': _OPTIMISM_ALCHEMY_RPC_URL,
  'arbitrum': _ARBITRUM_ALCHEMY_RPC_URL,
  'gnosis': _GNOSIS_ALCHEMY_RPC_URL,
  'celo': _CELO_ALCHEMY_RPC_URL,
}

NFT_URLS: dict[Network, str] = {
  'ethereum': _ETHEREUM_ALCHEMY_NFT_URL,
  'bnb': _BNB_ALCHEMY_NFT_URL,
  'polygon': _POLYGON_ALCHEMY_NFT_URL,
  'base': _BASE_ALCHEMY_NFT_URL,
  'avalanche': _AVAX_ALCHEMY_NFT_URL,
  'optimism': _OPTIMISM_ALCHEMY_NFT_URL,
  'arbitrum': _ARBITRUM_ALCHEMY_NFT_URL,
  'gnosis': _GNOSIS_ALCHEMY_NFT_URL,
  'celo': _CELO_ALCHEMY_NFT_URL,
}
...
class Alchemy:
  ...
  def portfolio(self) -> Portfolio:
    ...
    url = self.data_url or _authed_url(_path_join(_ALCHEMY_DATA_API_URL, 'data/v1'), self.api_key)
    return Portfolio(base_url=url, http=self.http, validate=self.validate)

  @property
  def prices(self) -> Prices:
    """Access the Prices API group."""
    url = self.prices_url or _authed_url(_path_join(_ALCHEMY_DATA_API_URL, 'prices/v1'), self.api_key)
